...
public extension UITableView {
   ...
   */
    ...
    /**
    Register a NibFile-Based `UITableViewCell` subclass (conforming to `Reusable`)

    - parameter cellType: the `UITableViewCell` (`Reusable`-conforming) subclass to register

    - seealso: `register(_ nib:,forCellReuseIdentifier:)`

    - description: This is useful if your cell is defined entirely in code
    */
    final func registerNibFileBasedCell<T: UITableViewCell>(cellType: T.Type) {
